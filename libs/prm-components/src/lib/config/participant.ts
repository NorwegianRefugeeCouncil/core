...
export const participantConfig: EntityUIConfigLoader = (staticData) => ({
  ...
  list: {
    fields: [
      ...
      { path: ['lastName'], title: 'Last Name', width: 2, sortKey: 'lastName' },
      { path: ['sex'], title: 'Sex', width: 2, sortKey: 'sex' },
      {
        path: ['dateOfBirth'],
        title: 'Date of Birth',
        width: 2,
